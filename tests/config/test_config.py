...
def test_config_error(gcovr_test_exec: "GcovrTestExec") -> None:
    ...
    with pytest.raises(ValueError) as exception:
        gcovr_test_exec.gcovr("--config", "config/gcovr.error.config", use_main=True)
...
def test_config_deprecated(
    ...
    gcovr_test_exec.gcovr("--config", "config/gcovr.deprecated.config", use_main=True)
...
def test_config(gcovr_test_exec: "GcovrTestExec") -> None:
    ...
    gcovr_test_exec.run("testcase")
    gcovr_test_exec.gcovr("--config", "config/gcovr.json.config")
